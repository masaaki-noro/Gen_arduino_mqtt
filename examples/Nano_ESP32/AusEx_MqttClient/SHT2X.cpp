...
AusExSHT2x sht2x = AusExSHT2x(&I2C_IF, SENSOR_SHT2X_TYPE,SENSOR_ID_SHT2X_TEMPERATURE,SENSOR_ID_SHT2X_HUMIDITY);
#else /* SENSOR_ID_SHT2X_HUMIDITY */
AusExSHT2x sht2x = AusExSHT2x(&I2C_IF, SENSOR_SHT2X_TYPE,SENSOR_ID_SHT2X_TEMPERATURE);
#endif /* SENSOR_ID_SHT2X_HUMIDITY */
#else /* SENSOR_ID_SHT2X_TEMPERATURE */
#ifdef SENSOR_ID_SHT2X_HUMIDITY
AusExSHT2x sht2x = AusExSHT2x(&I2C_IF, SENSOR_SHT2X_TYPE,,SENSOR_ID_SHT2X_HUMIDITY);
#else /* SENSOR_ID_SHT2X_HUMIDITY */
AusExSHT2x sht2x = AusExSHT2x(&I2C_IF, SENSOR_SHT2X_TYPE);
#endif /* SENSOR_ID_SHT2X_HUMIDITY */
