...
#ifdef SENSOR_ID_AM232X_TEMPERATURE
#ifdef SENSOR_ID_AM232X_HUMIDITY
AusExAM232X am232x = AusExAM232X(&I2C_IF, SENSOR_AM232X_TYPE,SENSOR_ID_AM232X_TEMPERATURE,SENSOR_ID_AM232X_HUMIDITY);
#else /* SENSOR_ID_AM232X_HUMIDITY */
AusExAM232X am232x = AusExAM232X(&I2C_IF, SENSOR_AM232X_TYPE,SENSOR_ID_AM232X_TEMPERATURE);
#endif /* SENSOR_ID_AM232X_HUMIDITY */
#else /* SENSOR_ID_AM232X_TEMPERATURE */
#ifdef SENSOR_ID_AM232X_HUMIDITY
AusExAM232X am232x = AusExAM232X(&I2C_IF, SENSOR_AM232X_TYPE,,SENSOR_ID_AM232X_HUMIDITY);
#else /* SENSOR_ID_AM232X_HUMIDITY */
AusExAM232X am232x = AusExAM232X(&I2C_IF, SENSOR_AM232X_TYPE);
#endif /* SENSOR_ID_AM232X_HUMIDITY */
#endif /* SENSOR_ID_AM232X_TEMPERATURE */
