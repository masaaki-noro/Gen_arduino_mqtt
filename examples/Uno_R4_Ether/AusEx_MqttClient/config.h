...
#define FIX_MAC_ADDRESS 0x90, 0xa2, 0xda, 0x10, 0x8d, 0x7a
#define USE_DHCP
...
#define USE_SENSOR_ANALOG_TEMPERATURE
#define SENSOR_GROVE_ANALOG_TEMPERATURE_PIN A0
