...
AusExGroveInfraredReflectiveSensor groveIrRefrective = AusExGroveInfraredReflectiveSensor(SENSOR_IR_RPR_220_PIN, SENSOR_ID_IR_RPR_220);
...
void groveIrRefrective_output_info(void) {
  sensor_t sensor;
  groveIrRefrective.getSensor(&sensor);
...
void groveIrRefrective_Sensor(void) {
  ...
  if (groveIrRefrective.getEvent(&event)) {
