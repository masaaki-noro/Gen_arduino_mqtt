...
AusExSHT31 sht31 = AusExSHT31(&Wire, SENSOR_ID_SHT31_TEMPERATURE,SENSOR_ID_SHT31_HUMIDITY);
#else /* SENSOR_ID_SHT31_HUMIDITY */
AusExSHT31 sht31 = AusExSHT31(&Wire, SENSOR_ID_SHT31_TEMPERATURE);
#endif /* SENSOR_ID_SHT31_HUMIDITY */
#else /* SENSOR_ID_SHT31_TEMPERATURE */
#ifdef SENSOR_ID_SHT2X_HUMIDITY
AusExSHT31 sht31 = AusExSHT31(&Wire, ,SENSOR_ID_SHT31_HUMIDITY);
#else /* SENSOR_ID_SHT31_HUMIDITY */
